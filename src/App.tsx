...
const required = [
    'no_ijazah', 'no_skhun', 'no_kk', 'no_akta_kelahiran',
    'nama_lengkap', 'jenis_kelamin', 'agama', 'nisn', 'no_induk', 'nik',
    'tempat_lahir', 'tgl_lahir', 'tinggi', 'berat',
    'no_hp', 'email',
    'nama_ayah', 'pekerjaan_ayah', 'pendidikan_ayah', 'penghasilan_ayah',
    'nama_ibu', 'pekerjaan_ibu', 'pendidikan_ibu',
    'jenis_tinggal', 'alamat', 'propinsi', 'no_hp_ortu', 'jarak_ke_sekolah', 'alat_transport'
];
...
export default () => {
    ...
    if (localStorage.ppdbId) {
        return <div className={"wrapper"}>
            ...
            <div style={{marginTop: 20, marginBottom: 20}}><MessageBar messageBarType={MessageBarType.success}>
                Silakan lanjutkan untuk melakukan pembayaran menggunakan aplikasi Edumatis, berikut ini adalah informasi
                login anda
            </MessageBar></div>

            <div style={{display: "flex", alignItems: "center", justifyContent: "space-around"}}>
                <pre style={{margin: 50, textAlign: 'left', fontWeight: 'bold',}} className="ms-font-xl">
                Kode Siswa: {sekolah.id.pad(3)}-{localStorage.ppdbId}<br/>
                Password  : 123
                </pre>

                <DefaultButton style={{float: 'right'}} onClick={() => {
                    if (confirm("Mohon catat KodeSiswa dan Password, sudah dicatat ?")) {
            ...
            <div style={{display: "flex", alignItems: "center", justifyContent: "center"}}>
                <img src="/edu0.png" alt="Edumatis Play Store"/><br/>
                <img src="/edu1.png" alt="Edumatis Login"/><br/>
            </div>
        </div>
    }
    ...
    return <div className={"wrapper"}>
        ...
        {({
            ...
            loaded:
                <div style={{marginTop: 20, marginBottom: 20}}><MessageBar messageBarType={MessageBarType.success}>
                    Data anda sebelumnya berhasil dimuat. Silakan melanjutkan pengisian form.
                    <br/><br/>
        ...
        <div className="ms-Grid" dir="ltr">
            ...
            <div className="ms-Grid-row">
                ...
                <div className="ms-Grid-col ms-sm6 ms-md6">
                    <TextField label="No. Kartu Keluarga"
                               field="no_kk"
                               type="number"
                               data={data} setData={setData} errors={errors} setErrors={setErrors}
                    />
            ...
            <div className="ms-Grid-row">
                ...
                <div className="ms-Grid-col ms-sm4">
                    <TextField label="No. Induk Siswa"
                               field="no_induk"
                               data={data} setData={setData} errors={errors} setErrors={setErrors}
                    />
                </div>
            ...
            <div className="ms-Grid-row">
                <div className="ms-Grid-col ms-sm6 ms-md6">
                    <TextField label="No. Ijazah Sebelumnya"
                               field="no_ijazah"
                               type="number"
                               data={data} setData={setData} errors={errors} setErrors={setErrors}
                    />
                ...
                <div className="ms-Grid-col ms-sm6 ms-md6 ">
                    <TextField label="No. SKHUN Sebelumnya"
                               field="no_skhun"
                               type="number"
                               data={data} setData={setData} errors={errors} setErrors={setErrors}
                    />
            ...
            <div className="ms-Grid-row">
                ...
                <div className="ms-Grid-col ms-sm6 ms-md3">
                    <DatePicker value={moment(data.tgl_lahir).toDate()}
                                formatDate={(date: Date | undefined): string => {
                                    return moment(date).format("DD MMM YYYY");
                                }}
                                onSelectDate={(date: Date | null | undefined) => {
                                    if (date != null)
                                        setData({...data, tgl_lahir: moment(date).format("YYYY-MM-DD")});
                                }}
            ...
            <div className="ms-Grid-row">
                ...
                <div className="ms-Grid-col ms-sm6">
                    <TextField label="Rombongan Belajar (Rombel)"
                               field="rombel"
                               data={data} setData={setData} errors={errors} setErrors={setErrors}
                    />
                </div>
            ...
            <div className="ms-Grid-row">
                <div className="ms-Grid-col ms-sm1 ms-md4"/>
                ...
                <div className="ms-Grid-col ms-sm4 ms-md2">
                    <TextField label="Kode Pos"
                               field="alamat_kodepos"
                               data={data} setData={setData} errors={errors} setErrors={setErrors}
                    />
                </div>
            </div>
            ...
            <div className="ms-Grid-row">
                <div className="ms-Grid-col ms-sm6 ms-md3">
                    <TextField field="kelurahan"
                               label="Kelurahan/Desa"
                               data={data} setData={setData} errors={errors} setErrors={setErrors}
                    />
                </div>
                <div className="ms-Grid-col ms-sm6 ms-md3">
                    <TextField field="kecamatan"
                               label="Kecamatan"
                               data={data} setData={setData} errors={errors} setErrors={setErrors}
                    />
                </div>
                <div className="ms-Grid-col ms-sm6 ms-md3">
                    <TextField field="kabupaten"
                               label="kabupaten"
                               data={data} setData={setData} errors={errors} setErrors={setErrors}
                    />
                </div>
                <div className="ms-Grid-col ms-sm6 ms-md3">
                    <TextField field="propinsi"
                               label="Propinsi"
                               data={data} setData={setData} errors={errors} setErrors={setErrors}
                    />
                </div>
            ...
            <div className="ms-Grid-row">
                <div className="ms-Grid-col ms-sm6 ms-md6">
                    <TextField field="no_hp_ortu"
                               label="No. HP Orang Tua / Wali"
                               data={data} setData={setData} errors={errors} setErrors={setErrors}
                    />
                </div>
                <div className="ms-Grid-col ms-sm6 ms-md6">
                    <TextField field="jarak_ke_sekolah"
...
const Dropdown = ({field, label, items, data, setData, errors, setErrors}: any) => {
    const [list, setList] = useState(items);
    if (!!data[field] && list.indexOf(data[field]) < 0) {
        setList([...items, data[field]]);
    }
    return <FabricDropdown label={label}
...
const Loader = (props: any) => <ContentLoader
    height={160}
    width={400}
    speed={2}
    primaryColor="#f3f3f3"
